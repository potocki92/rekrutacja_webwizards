const e=document.getElementById("backdrop"),t=document.getElementById("header"),c=document.querySelector(".nav"),n=document.getElementById("menu-toggle"),s=document.getElementById("check"),d=document.getElementById("check__svg"),o=document.getElementById("contact"),i=document.getElementById("close"),l=document.querySelector("#errorMessage");// Tło modalne
...
s.addEventListener("click",()=>{d.classList.toggle("check")});//# sourceMappingURL=index.d0fb53f1.js.map

//# sourceMappingURL=index.d0fb53f1.js.map
